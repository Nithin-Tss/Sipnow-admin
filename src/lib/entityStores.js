...
export const usersStore = createMockStore(
  "sipnow_admin_users",
  [
    {
      _id: "user-seed-1",
...
export const suppliersStore =
  createMockStore(
    "sipnow_admin_suppliers",
    [
      {
        _id: "supplier-seed-1",
        name: "Lone Star Distributors",
        contactEmail:
          "orders@lonestardist.com",
        phone: "(512) 555-0100",
        region: "Texas",
      },
      {
    ...
    [
      {
        ...
        group: "wine",
        description:
          "Full and light-bodied red wines.",
      },
      {
        _id: "cat-seed-2",
        name: "Vodka",
      ...
      },
      {
        ...
        group: "beer",
        description:
          "Local and imported craft beers.",
      },
    ]
  );
    ...
    [
      {
        _id: "offer-seed-1",
        title:
          "Buy 2 Get 1 Free — Craft Beer",
        badgeText: "BOGO",
        description:
          "Limited-time bundle offer on selected craft beers.",
        active: true,
      },
      {
        _id: "offer-seed-2",
    ...
    [
      {
        ...
        rating: 5,
        comment:
          "Absolutely wonderful, smooth and rich.",
        status: "approved",
      },
      {
        _id: "review-seed-2",
    ...
    [
      {
        ...
        body:
          "Hi, when can I expect my order to arrive?",
        status: "unread",
      },
      {
        _id: "msg-seed-2",
        ...
        fromEmail:
          "wade@example.com",
        subject:
          "Damaged bottle in order",
        body:
          "One of the bottles arrived cracked, can I get a replacement?",
        status: "read",
      },
    ]
  );